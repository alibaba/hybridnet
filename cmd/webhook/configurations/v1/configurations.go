...
import (
	...
	arclient "k8s.io/client-go/kubernetes/typed/admissionregistration/v1"
...
var validatingWebhookConfiguration *arv1.ValidatingWebhookConfiguration
var mutatingWebhookConfiguration *arv1.MutatingWebhookConfiguration

func BuildConfigurations(address string, port int, caCertPath string) {
	validatingWebhookConfiguration = &arv1.ValidatingWebhookConfiguration{
		...
		Webhooks: []arv1.ValidatingWebhook{
			{
				...
				FailurePolicy:           failurePolicyPointer(arv1.Fail),
				SideEffects:             sideEffectClassPointer(arv1.SideEffectClassNone),
	...
	mutatingWebhookConfiguration = &arv1.MutatingWebhookConfiguration{
		ObjectMeta: metav1.ObjectMeta{
...
func failurePolicyPointer(f arv1.FailurePolicyType) *arv1.FailurePolicyType {
	return &f
}

func sideEffectClassPointer(s arv1.SideEffectClass) *arv1.SideEffectClass {
	return &s
}
