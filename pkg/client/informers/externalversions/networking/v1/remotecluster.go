	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1().RemoteClusters().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1().RemoteClusters().Watch(context.TODO(), options)
			},
		},
		&networkingv1.RemoteCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *remoteClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkingv1.RemoteCluster{}, f.defaultInformer)
}
