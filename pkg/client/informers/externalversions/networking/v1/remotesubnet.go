	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1().RemoteSubnets().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1().RemoteSubnets().Watch(context.TODO(), options)
			},
		},
		&networkingv1.RemoteSubnet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *remoteSubnetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkingv1.RemoteSubnet{}, f.defaultInformer)
}
